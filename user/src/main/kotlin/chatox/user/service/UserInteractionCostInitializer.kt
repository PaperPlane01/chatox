    ...
    fun createUserInteractionsCosts() {
        mono {
            ...
            if (existingUserInteractionCosts.isEmpty()) {
                ...
                if (config.updateExisting) {
                    ...
                    existingUserInteractionCosts.forEach { userInteractionCost ->
                        if (configuredUserInteractionCostsMap.containsKey(userInteractionCost.type)) {
                            val configuredUserInteractionCost =
                                configuredUserInteractionCostsMap[userInteractionCost.type]!!
                            userInteractionCostsToUpdate.add(
                                userInteractionCost.copy(
                ...
                log.info(
                    "${userInteractionsCostsToCreate.size} user interactions costs will be created and " +
