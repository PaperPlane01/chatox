        ...
        return mono {
            ...
            return@mono CurrentUser(
                ...
                globalBan = if (lastActiveBan != null) globalBanMapper.toGlobalBanResponse(
                    ...
                    updatedBy = if (lastActiveBan.updatedById != null) userReactiveRepositoryCacheWrapper.findById(
                        lastActiveBan.updatedById!!
                    ).awaitFirst() else null,
                    canceledBy = if (lastActiveBan.cancelledById != null) userReactiveRepositoryCacheWrapper.findById(
                        lastActiveBan.cancelledById!!
                    ).awaitFirst() else null
                ) else null,
