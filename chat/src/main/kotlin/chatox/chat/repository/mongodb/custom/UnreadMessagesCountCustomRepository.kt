...
interface UnreadMessagesCountCustomRepository {
    fun increaseUnreadMessagesCountForChat(
        chatId: String,
        increaseCount: Long = 1,
        excludedChatParticipations: List<String> = listOf()
    ): Mono<Unit>

    fun decreaseUnreadMessagesCount(
        chatParticipationId: String,
        lastReadMessage: Message,
        decreaseUnreadMentionsCount: Boolean = false
    ): Mono<Unit>
