...
@Component
@Transactional
class UserBlacklistListener(
    private val userBlacklistItemRepository: UserBlacklistItemRepository,
    ...
    fun onUserAddedToBlacklist(
        userAddedToBlacklist: UserAddedToBlacklist,
        channel: Channel,
        @Header(AmqpHeaders.DELIVERY_TAG) tag: Long
    ) {
        mono {
            if (!userBlacklistItemRepository.existsByUserIdAndBlacklistedById(
                    userAddedToBlacklist.userId,
                    userAddedToBlacklist.addedById
                ).awaitFirst()
            ) {
                userBlacklistItemRepository.save(
                    UserBlacklistItem(
    ...
    fun onUserRemovedFromBlacklist(
