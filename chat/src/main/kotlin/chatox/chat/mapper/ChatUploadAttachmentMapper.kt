...
@Component
class ChatUploadAttachmentMapper(
        ...
        return mono {
            val (messagesIds, usersIds) = mapTo2Lists(
                ...
                { chatUploadAttachment ->
                    listOf(
                        chatUploadAttachment.uploadSenderId,
                        chatUploadAttachment.uploadCreatorId
                    )
                }
            )
            ...
            val result = chatUploadAttachments.map { attachment ->
    ...
    private fun filterAttachments(): (ChatUploadAttachment<*>) -> Boolean {
        return { chatUploadAttachment ->
            chatUploadAttachment.messageId != null
