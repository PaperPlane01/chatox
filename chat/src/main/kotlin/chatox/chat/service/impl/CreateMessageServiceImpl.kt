...
class CreateMessageServiceImpl(
    ...
    private fun createScheduledMessage(
        chatId: String,
        createMessageRequest: CreateMessageRequest,
        currentUser: JwtPayload
    ): Mono<MessageResponse> {
        return mono {
            ...
            val numberOfMessagesScheduledCloseToThisMessage =
    ...
    override fun createFirstMessageForPrivateChat(
        chatId: String,
        createMessageRequest: CreateMessageRequest,
    ...
    override fun forwardMessages(
        ...
        return mono {
            ...
            messages.zip(messages.indices).forEach { (message, index) ->
                ...
                val chatUploadAttachments = message.attachments.map { upload ->
    ...
    private fun createMessageFromRequest(
        ...
        return mono {
            ...
            if (!chatNotCreated) {
                messageReadService.increaseUnreadMessagesCountForChat(chatId, listOf(chatParticipation.id))
                    .awaitFirstOrNull()
