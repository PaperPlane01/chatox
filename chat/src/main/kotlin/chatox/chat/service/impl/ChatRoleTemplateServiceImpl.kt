...
class ChatRoleTemplateServiceImpl(
    ...
    override fun updateChatRoleTemplate(
        id: String,
    ...
    override fun getChatRoleTemplates(): Flux<ChatRoleTemplateResponse> {
        ...
        return chatRoleTemplateRepository
            .findAll()
            .flatMap { chatRoleTemplate ->
                chatRoleTemplateMapper.toChatRoleTemplateResponse(
                    chatRoleTemplate,
                    localUsersCache
                )
            }
        ...
        return mono {
            for (defaultChatRoleTemplate in defaultRoleTemplates) {
                ...
                if (existingRoleTemplate == null) {
                    ...
                    chatRoleTemplateRepository.save(
                        existingRoleTemplate.copy(
                            level = name.level,
                            features = features,
                            updatedAt = ZonedDateTime.now(),
                            updatedBy = null
