...
interface ChatParticipationService {
    ...
    fun findParticipantsWithRole(
        chatId: String,
        roleId: String,
        paginationRequest: PaginationRequest
    ): Flux<ChatParticipationResponse>

    fun findPendingChatParticipations(
        chatId: String,
        paginationRequest: PaginationRequest
    ): Flux<PendingChatParticipationResponse>

    fun approveChatParticipants(
        chatId: String,
        pendingChatParticipantsRequest: PendingChatParticipantsRequest
    ): Flux<ChatParticipationResponse>

    fun rejectChatParticipants(
        chatId: String,
        pendingChatParticipantsRequest: PendingChatParticipantsRequest
    ): Mono<Unit>

    fun findChatParticipationsByInvite(
        chatId: String,
        inviteId: String,
        paginationRequest: PaginationRequest
    ): Flux<ChatParticipationResponse>

    fun findPendingChatParticipationsByInvite(
        chatId: String,
        inviteId: String,
        paginationRequest: PaginationRequest
    ): Flux<PendingChatParticipationResponse>

    fun getMentionedChatParticipants(
        chatId: String,
        textInfo: TextInfo,
