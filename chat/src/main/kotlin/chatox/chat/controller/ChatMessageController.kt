...
class ChatMessageController(
    ...
    fun findMessageByChatIdAndMessageId(
        @PathVariable chatId: String,
        @PathVariable messageId: String
    ...
    fun searchMessagesInChatsOfCurrentUser(
        @RequestParam query: String,
        paginationRequest: PaginationRequest
    ...
    fun findScheduledMessagesBuChat(@PathVariable("chatId") chatId: String) =
        scheduledMessageService.findScheduledMessagesByChat(chatId)
