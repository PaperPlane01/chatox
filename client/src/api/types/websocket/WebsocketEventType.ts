export enum WebsocketEventType {
    ...
    CHAT_NOTIFICATIONS_SETTINGS_UPDATED = "CHAT_NOTIFICATIONS_SETTINGS_UPDATED",
    CHAT_NOTIFICATIONS_SETTINGS_DELETED = "CHAT_NOTIFICATIONS_SETTINGS_DELETED",
    GLOBAL_NOTIFICATIONS_SETTINGS_UPDATED = "GLOBAL_NOTIFICATIONS_SETTINGS_UPDATED",
    DRAFT_MESSAGE_CREATED = "DRAFT_MESSAGE_CREATED",
    DRAFT_MESSAGE_UPDATED = "DRAFT_MESSAGE_UPDATED",
