...
export const en: Labels = {
    ...
    "notification.sound.for-chat": "Notification sound for chat {chatName}",
    "notification.sound.for-group-chats": "Notification sound for group chats",
    "notification.sound.for-dialog-chats": "Notification sound for dialogs",
    "notification.sound.for-chat.with-user": "Notification sound for chat with user {username}",
    "notification.sound.for-user-in-chat": "Notification sound for user {username} in chat {chatName}",
    "notification.level.MUTED": "Muted",
    "notification.level.MENTIONS_AND_REPLIES": "Mentions and replies",
    "notification.level.ALL_MESSAGES": "All messages",
    ...
    "notification.settings.add-user-exception": "Add user exception",
    "notification.settings.user-exceptions": "{exceptionsCount} user exceptions",
