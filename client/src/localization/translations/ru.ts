...
export const ru: Labels = {
    ...
    "sticker.pack.delete": "Удалить набор стикеров",
    "sticker.pack.delete.consent": "Я понимаю, что данное действие необратимое и что данный набор стикеров будет невозможно восстановить",
    "sticker.pack.delete.delete-messages": "Удалить все сообщения со стикерами из данного набора",
    ...
    "sticker.pack.delete.success": "Набор стикеров был удалён",
    "sticker.pack.delete.with-name": "Удалить набор стикеров {stickerPackName}",
    ...
    "sticker.pack.update.error.server-unreachable": "При обновлении набора стикеров произошла ошибка: сервер недоступен",
