...
class StickerPackServiceImpl(
    ...
    override fun updateStickerPack(
        id: String,
        updateStickerPackRequest: UpdateStickerPackRequest
    ): Mono<StickerPackResponse<*>> {
        return mono {
            val currentUser = authenticationHolder.requireCurrentUserDetails().awaitFirst()
    ...
    override fun addStickersToStickerPack(
        id: String,
        createStickerRequests: List<CreateStickerRequest>
    ): Flux<StickerResponse> {
        return mono {
            val currentUser = authenticationHolder.requireCurrentUserDetails().awaitFirst()
            var stickerPack = findStickerPackByIdInternal(id).awaitFirst()
            val stickers = createStickers(
    ...
    override fun deleteStickerPack(id: String, deleteMessages: Boolean): Mono<Unit> {
        return mono {
            ...
            runAsync {
                stickerEventsProducer.stickerPackDeleted(
                    StickerPackDeleted(
                    id = id,
    ...
    private fun findStickerPacksInstalledByUser(userId: String): Flux<StickerPackResponse<*>> {
        return mono {
            ...
            val installedStickerPacks =
                stickerPackRepository.findAllById(installedStickerPacksIds).collectList().awaitFirst()
        ...
        return mono {
            ...
            return@mono Flux.fromIterable(
                stickerPacks
                    ...
                    .map { stickerPack ->
                        stickerPackMapper.toStickerPackResponse(
                            stickerPack = stickerPack,
